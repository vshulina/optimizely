...
# functions for getting experiment and variant id's from Optimizely
...
def create_file():
    ...
    variation[['customer_id', 'ab_group']].to_csv((os.getcwd()+'/Output/'+output_name+'.csv'), index = None)
